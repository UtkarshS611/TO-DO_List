      ...
      {isMobileView ? (
        <aside className={`max-w-72 w-full fixed shadow-md hidden lg:block ${mode === "dark"? "bg-[#2c2c2c]" : "bg-emerald-50"} `}>
          ...
          <div className={`h-36 w-full relative`}>
            <div className="h-24 w-24 rounded-full p-2 bg-white/80 shadow-md absolute left-[50%] translate-x-[-50%] bottom-[-35%] cursor-pointer" onClick={handleProfileOptions}>
              <img
                src="/Profile.webp"
          ...
          <div className="mt-14 font-semibold text-center">
            <h1>Hey, John</h1>
            <div className={`flex-col border m-3 ${profileOptions? "flex" : "hidden"}  ${mode === "dark"? "bg-[#232323]" : "bg-white"}`}>
        ...
        <aside className={`w-full absolute left-0 ${isSidebarOpen? "block" : "hidden"} shadow-md ${mode === "dark"? "bg-[#2c2c2c]" : "bg-emerald-50"} `}>
